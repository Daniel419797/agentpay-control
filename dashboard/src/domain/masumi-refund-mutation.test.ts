...
describe("Masumi refund mutation safety", () => {
  ...
  it("never blindly retries ambiguous transport or provider-contract outcomes", () => {
    ...
    expect(isAmbiguousMasumiRefundError(new Error("MASUMI_PAYMENT_PROVIDER_400"))).toBe(false);
  });
});
